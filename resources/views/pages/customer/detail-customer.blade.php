...
<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-4">
            ...
            <div class="w-full bg-white rounded-lg shadow h-fit">
                <div class="flex flex-col xl:flex-row px-4 py-2 gap-2">
                    ...
                    <div class="flex-none py-2 relative">
                        <x-dropdown>
                            <x-slot name="trigger">
                                <button class="focus:outline-none transition ease-in-out duration-150 absolute xl:relative bottom-56 md:bottom-60 lg:bottom-56 xl:bottom-0 left-80 lg:left-[18rem] md:left-44 xl:left-0">
