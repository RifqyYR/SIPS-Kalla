        ...
        <div class="container bg-white p-6 rounded">
            ...
            <div class="mt-4">
                ...
                <select id="sector" name="sector"
                    ...
                    <option value="{{ \App\Models\PersonInCharge::SECTOR_FREE_DRINK }}">Minuman Gratis</option>
                    ...
                    <option value="{{ \App\Models\PersonInCharge::SECTOR_SPAREPART }}">Sparepart</option>
                </select>
            </div>
